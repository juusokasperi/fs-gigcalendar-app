...
__Create__ env files according to `env.example`, `backend/env.example`, `frontend/env.example` and create the docker secrets according to the example files in `secrets/`
